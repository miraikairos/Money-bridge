...
const dealSchema = new mongoose.Schema(
  {
    ...
    counterpart: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null }, // set on accept
    ...
    paymentRef: { type: String, default: '' }, // Member 3 can store tx/escrow id
...
// Virtual helpers used by controllers
dealSchema.methods.getSellerId = function () {
  return this.creatorRole === 'seller' ? this.creator : this.counterpart;
};
dealSchema.methods.getBuyerId = function () {
  return this.creatorRole === 'buyer' ? this.creator : this.counterpart;
};
